                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <form action="<?= BASEURL . '/mentor/laporanharian' ?>" method="post">
                                ...
                                <table class="table table-bordered">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th scope="col" class="text-center">Laporan Harian</th>
                                        </tr>
                                    </thead>
                                        <tbody>
                                            <?php if(!$data['peserta']) : ?>
                                                ...
                                                <?php foreach($data['peserta'] as $peserta) : ?>
                                                    <?php if($peserta['is_actived'] === 1 && $peserta['mentor'] === $_SESSION['session']['username']) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><a href="<?= BASEURL . '/mentor/laporanharianpeserta/' . $peserta['username'] ?>">Lihat laporan</a></td>
                                                        </tr>
                                                    <?php endif ?>
                                                <?php endforeach; ?>
                                            <?php endif ?>
                            ...
                            <ul class="pagination pagination-sm justify-content-center">
                                <?php if($data['hlmAktif'] > 1) : ?>
                                    ...
                                    <li class="page-item"><a class="page-link" href="<?= BASEURL . '/mentor/laporanharian/' . $prev ?>">Previous</a></li>
                                <?php endif ?>

                                <?php for($i = 1; $i <= $data['jmlHalaman']; $i++) : ?>
                                    <?php if($i == $data['hlmAktif']) : ?>
                                        <li class="page-item active"><a class="page-link" href="<?= BASEURL . '/mentor/laporanharian/' . $i ?>"><?= $i ?></a></li>
                                    <?php else : ?>
                                        <li class="page-item"><a class="page-link" href="<?= BASEURL . '/mentor/laporanharian/' . $i ?>"><?= $i ?></a></li>
                                    <?php endif ?>
                                <?php endfor ?>

                                <?php if($data['hlmAktif'] < $data['jmlHalaman']) : ?>
                                    <?php $next = $data['hlmAktif'] + 1; ?>
                                    <li class="page-item"><a class="page-link" href="<?= BASEURL . '/mentor/laporanharian/' . $next ?>">Next</a></li>
                                <?php endif ?>
                            </ul>
                            </nav>
                        </div>
