                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col">
                                    <div class="font-weight-bold text-primary text-uppercase mb-1">
                                        TOTAL PESERTA (DISETUJUI)</div>
                                    <div class="h5 mb-0 font-weight text-gray-800"><?= $data['pesertaDisetujui'][0]['COUNT(*)'] ?></div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters">
                                <div class="col">
                                    <div class="font-weight-bold text-danger text-uppercase mb-1">
                                        TOTAL PESERTA (BELUM DISETUJUI)</div>
                                    <div class="h5 mb-0 font-weight text-gray-800"><?= $data['pesertaBelumDisetujui'][0]['COUNT(*)'] ?></div>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-user fa-3x text-gray-300"></i>
                                </div>
