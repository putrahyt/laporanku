                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <form action="<?= BASEURL . '/mentor/peserta' ?>" method="post">
                                                ...
                                                <?php foreach($data['peserta'] as $peserta) : ?>
                                                    <?php if($peserta['is_actived'] === 1 && $peserta['mentor'] === $_SESSION['session']['username']) : ?>
                                                        <tr>
                                                            ...
                                                            <?php else : ?>
                                                                <td class="text-center"><span class="text-center badge badge-pill badge-success">Sudah Disetujui Mentor</span></td>
                                                            <?php endif ?>
                                                            <td class="text-center">
                                                                <a href="<?= BASEURL . '/mentor/detailPeserta/' . $peserta['id'] ?>" class="btn btn-primary" title="Detail"><i class="fa-solid fa-circle-info fa-sm"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php endif ?>
                                                <?php endforeach; ?>
                            ...
                            <ul class="pagination pagination-sm justify-content-center">
                                <?php if($data['hlmAktif'] > 1) : ?>
                                    ...
                                    <li class="page-item"><a class="page-link" href="<?= BASEURL . '/mentor/peserta/' . $prev ?>">Previous</a></li>
                                <?php endif ?>

                                <?php for($i = 1; $i <= $data['jmlHalaman']; $i++) : ?>
                                    <?php if($i == $data['hlmAktif']) : ?>
                                        <li class="page-item active"><a class="page-link" href="<?= BASEURL . '/mentor/peserta/' . $i ?>"><?= $i ?></a></li>
                                    <?php else : ?>
                                        <li class="page-item"><a class="page-link" href="<?= BASEURL . '/mentor/peserta/' . $i ?>"><?= $i ?></a></li>
                                    <?php endif ?>
                                <?php endfor ?>

                                <?php if($data['hlmAktif'] < $data['jmlHalaman']) : ?>
                                    <?php $next = $data['hlmAktif'] + 1; ?>
                                    <li class="page-item"><a class="page-link" href="<?= BASEURL . '/mentor/peserta/' . $next ?>">Next</a></li>
                                <?php endif ?>
                            </ul>
                            </nav>
                        </div>
