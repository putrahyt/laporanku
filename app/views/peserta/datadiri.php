...
<div id="layoutSidenav_content">
        ...
        <div class="container-fluid">
                    ...
                    <div class="card shadow-sm mb-4 p-1" style="max-width: 100%;">
                        <div class="row no-gutters ml-1">
                            <div class="col-md-4">
                                <img src="<?= BASEURL . '/asset/img/' . $data['peserta']['image'] ?>" alt="profil" width="100%" height="83%" style="object-fit: cover;" class="mt-4">
                            </div>
                            <div class="col-md-7">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-success mb-4 ubahDataPeserta" data-toggle="modal" data-target="#ubahDataPeserta" data-id="<?= $data['peserta']['id']?>" data-url=<?= BASEURL ?>></i>
                                        Ubah Data
                                    </button>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="ubahDataPeserta" tabindex="-1" aria-labelledby="Data" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= BASEURL; ?>/peserta/ubahDataPeserta" method="POST" enctype="multipart/form-data">
